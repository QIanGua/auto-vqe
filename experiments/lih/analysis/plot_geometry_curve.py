...
Usage (from project root):
    uv run python experiments/lih/analysis/plot_geometry_curve.py
or
    uv run python experiments/lih/analysis/plot_geometry_curve.py path/to/lih_geometry_curve_2026....tsv

If no path is given, the script will automatically pick the latest
`lih_geometry_curve_*.tsv` in `experiments/lih/artifacts/runs/`.
"""
