...
Usage:
  uv run experiments/lih/mindquantum_uccsd_compare.py --dist 1.5
  uv run experiments/lih/mindquantum_uccsd_compare.py --dist 1.6
...
def load_repo_lih_reference() -> dict:
    ...
    data_path = repo_root / "experiments" / "lih" / "lih_pyscf_data.json"
...
def main() -> int:
    ...
    parser.add_argument(
        "--data-dir",
        type=Path,
        default=Path(__file__).resolve().parent / "mindquantum_data",
